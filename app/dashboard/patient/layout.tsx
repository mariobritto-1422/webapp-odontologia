    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
        <div className="px-4 py-3 flex items-center justify-between">
          <div>
            <p className="text-xs text-slate-400 leading-tight">Tu odontólogo</p>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 shadow-sm z-10">
...
function NavLink({ href, icon, label }: { href: string; icon: string; label: string }) {
  ...
  return (
    <Link
      href={href}
      className="flex flex-col items-center justify-center py-1.5 text-slate-500 hover:text-blue-600 transition-colors rounded-lg"
    >
